...
public class PedidoControllerImpl implements PedidoController {
	...
	@Override
	public ResponseEntity<Void> adicionar(PedidoDTO pedidoDTO, String authorization) {

		Long codigoUsuario = tokenService.getIdUsuario(tokenService.adquirirToken(authorization));
		
		pedidoService.adicionar(pedidoDTO, codigoUsuario);
